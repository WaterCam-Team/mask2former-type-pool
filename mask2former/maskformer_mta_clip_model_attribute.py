...
from .challenging_types import CHALLENGING_TYPES
# CHALLENGING_TYPES = ['transparent', 'reflective', 'glare', 'dark', 'muddy', 'rainy']

@META_ARCH_REGISTRY.register()
class MaskFormerMtaCLIP_attri(nn.Module):
    """
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            align_loss = self.masktext_alignment_loss_scene_type(outputs['text_clip'], outputs['mask_clip'], mask_to_gt_cls, outputs['psudo_label'])
